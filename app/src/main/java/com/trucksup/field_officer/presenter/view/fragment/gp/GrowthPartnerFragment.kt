...
import com.trucksup.field_officer.databinding.FragmentGrowPartnerBinding
import com.trucksup.field_officer.databinding.FragmentOwnerBinding
import com.trucksup.field_officer.presenter.view.fragment.ts.OwnerCompletedFragment
import com.trucksup.field_officer.presenter.view.fragment.ts.TruckOwnerScheduledFragment
import com.trucksup.fieldofficer.adapter.FragmentAdapter

class GrowthPartnerFragment : Fragment() {

    private lateinit var binding: FragmentGrowPartnerBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentGrowPartnerBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    private fun setupViewPager() {
        ...
        try {
            ...
            val fragment1 = TruckOwnerScheduledFragment()
            val fragment2 = OwnerCompletedFragment()
