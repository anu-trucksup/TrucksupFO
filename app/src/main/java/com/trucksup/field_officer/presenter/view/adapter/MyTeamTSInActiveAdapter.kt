...
class MyTeamTSInActiveAdapter(var context: Context?, var list: ArrayList<String>) :
    ...
    inner class ViewHolder(var binding: ItemMyTeamTsInactiveBinding) : RecyclerView.ViewHolder(binding.root)

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        var v = ItemMyTeamTsInactiveBinding.inflate(LayoutInflater.from(context), parent, false)
        return ViewHolder(v)
    }
