...
import com.trucksup.field_officer.databinding.OwnerFindItemBinding

class OwnerFind(var context: Context?, var list: ArrayList<String>) :
    RecyclerView.Adapter<OwnerFind.ViewHolder>() {

    private var controllerListener: ControllerListener? = null

    inner class ViewHolder(var binding: OwnerFindItemBinding) :
        RecyclerView.ViewHolder(binding.root)

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        var v = OwnerFindItemBinding.inflate(LayoutInflater.from(context), parent, false)
        return ViewHolder(v)
    }
