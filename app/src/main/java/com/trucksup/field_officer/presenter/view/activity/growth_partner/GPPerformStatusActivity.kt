...
class GPPerformStatusActivity : BaseActivity() {
    private lateinit var binding: ActivityGpPerformstatusBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        binding = DataBindingUtil.setContentView(this, R.layout.activity_gp_performstatus)
