...
import com.trucksup.field_officer.databinding.FragmentOwnerFindBinding
import com.trucksup.field_officer.presenter.utils.LoggerMessage
import com.trucksup.field_officer.presenter.utils.SharedPreference
import com.trucksup.field_officer.presenter.view.adapter.OwnerFind
...
class OwnerFindFragment : Fragment() {

    private var aContext: Context? = null
    private lateinit var binding: FragmentOwnerFindBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentOwnerFindBinding.inflate(inflater, container, false)
        return binding.root
    }
            ...
            DialogBoxes.addLeadDialog(aContext!!, "Add Truck Owner", object : AddLeadInterface {
                override fun onLocation(dialog: AlertDialog, binding: AddLeadLayoutBinding) {
                    binding.tvCurrentLocation.text =
                        activity?.findViewById<TextView>(R.id.addressUpdate)?.text
                }
            })
        }
    ...
    private fun setRvList() {
        ...
        binding.rv.apply {
            ...
            adapter = OwnerFind(aContext, list).apply {
                setOnControllerListener(object : OwnerFind.ControllerListener {
