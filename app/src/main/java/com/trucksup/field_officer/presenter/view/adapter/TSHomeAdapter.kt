...
import com.trucksup.field_officer.databinding.TsHomeItemBinding
...
class TSHomeAdapter(var context: Context?, var list: ArrayList<String>) :
    RecyclerView.Adapter<TSHomeAdapter.ViewHolder>() {

    inner class ViewHolder(var binding: TsHomeItemBinding) :
        RecyclerView.ViewHolder(binding.root)

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val v = TsHomeItemBinding.inflate(LayoutInflater.from(context), parent, false)
        return ViewHolder(v)
    }
