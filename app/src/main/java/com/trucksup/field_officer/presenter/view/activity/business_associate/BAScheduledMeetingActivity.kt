...
//            }
    ...
    private fun setRvPreferredLane() {
        binding.rvPreferredLane.apply {
            layoutManager =
                LinearLayoutManager(this@BAScheduledMeetingActivity, RecyclerView.VERTICAL, false)
            adapter = PreferredLaneAdap(
                this@BAScheduledMeetingActivity, preferredLaneList,
                this@BAScheduledMeetingActivity
            )
            hasFixedSize()
        }
    }
