...
class ICImageAdapter(var context: Context,var list:ArrayList<GetAllMiscLeadResponse.IncompletedLead.TruckImage>):RecyclerView.Adapter<ICImageAdapter.ViewHolder>() {
