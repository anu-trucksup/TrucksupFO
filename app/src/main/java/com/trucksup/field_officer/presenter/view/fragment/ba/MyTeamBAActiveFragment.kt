...
import com.trucksup.field_officer.databinding.FragmentMyTeamBaActiveBinding
...
class MyTeamBAActiveFragment : Fragment() {
    private var aContext: Context? = null
    private lateinit var binding: FragmentMyTeamBaActiveBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentMyTeamBaActiveBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    private fun setRvList() {
        ...
        binding.rvActiveBA.apply {
            ...
            adapter = MyTeamBAActiveAdapter(aContext, list).apply {
                setOnControllerListener(object : MyTeamBAActiveAdapter.ControllerListener {
