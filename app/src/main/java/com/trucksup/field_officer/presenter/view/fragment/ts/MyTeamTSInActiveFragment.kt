...
class MyTeamTSInActiveFragment : Fragment() {
    private var aContext: Context? = null
    private lateinit var binding: FragmentMyTeamTsInactiveBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentMyTeamTsInactiveBinding.inflate(inflater, container, false)
        return binding.root
    }
