        ...
        try {
            ...
            binding.viewPager2.registerOnPageChangeCallback(object :
                ...
                override fun onPageSelected(position: Int) {
                    ...
                    if (position == 0) {
                        binding.tabSchedule.setBackgroundDrawable(ContextCompat.getDrawable(this@TSPerformanceActivity, R.drawable.ba_tab_unselected_background));
                        binding.tabCompleted.setBackgroundDrawable(ContextCompat.getDrawable(this@TSPerformanceActivity, R.drawable.tab_selected_background));
                        ...
                        binding.tabCompleted.setBackgroundDrawable(ContextCompat.getDrawable(this@TSPerformanceActivity, R.drawable.ba_tab_unselected_background));
                        binding.tabSchedule.setBackgroundDrawable(ContextCompat.getDrawable(this@TSPerformanceActivity, R.drawable.tab_selected_background));
