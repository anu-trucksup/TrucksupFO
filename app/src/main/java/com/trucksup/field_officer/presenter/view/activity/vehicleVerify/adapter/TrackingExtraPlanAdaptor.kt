...
class TrackingExtraPlanAdaptor(
    val context: Context,
    var data: ArrayList<DataTrackingPlan>,
    var cantriler: TrackingPlanCountCantroler,
    var planDay: Int
) : RecyclerView.Adapter<TrackingExtraPlanAdaptor.ViewHolder>() {
    var co: Int = 0
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): TrackingExtraPlanAdaptor.ViewHolder {
    ...
    override fun onBindViewHolder(viewHolder: TrackingExtraPlanAdaptor.ViewHolder, position: Int) {
...
//            viewHolder.calculateLayout.visibility= View.VISIBLE
            ...
            if (data.get(position).counterDay <= 1) {
                ...
                viewHolder.units.text = context.getString(R.string.days)
            }
...
//        }
        ...
        viewHolder.pluse.setOnClickListener {
            ...
            var dataAdd = VasPlan(true, tt, data.get(position).vasId.toString())
