...
open class CommonApplication : Application() {
    companion object {
        const val imagePathUrl: String =
            "https://sslapi.trucksups.in/S3ImageAPI/get-imagefile?fileName="
        ...
        fun getSharedPreferences(): SharedPreferences? {
            if (appContext != null) {
                sharedPreferences =
                    appContext?.getSharedPreferences("trucksupfo_pref", Context.MODE_PRIVATE)
    ...
    override fun onCreate() {
        ...
        if (!Places.isInitialized()) {
            Places.initialize(applicationContext, "AIzaSyDRB7hEarzrrPCcs-QaGtVCpWDrkubxvs8")
        }
    }
