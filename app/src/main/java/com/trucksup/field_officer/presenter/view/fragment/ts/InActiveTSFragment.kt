...
import com.trucksup.field_officer.databinding.FragmentTsInactiveBinding
...
class InActiveTSFragment : Fragment() {
    private var aContext: Context? = null
    private lateinit var binding: FragmentTsInactiveBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentTsInactiveBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    private fun setRvList() {
        ...
        binding.rvActiveBA.apply {
            ...
            adapter = MyTeamTSInActiveAdapter(aContext, list).apply {
                setOnControllerListener(object : MyTeamTSInActiveAdapter.ControllerListener {
