...
import com.trucksup.field_officer.databinding.ActivityBaPerformstatusBinding
import com.trucksup.field_officer.databinding.ActivityGpPerformstatusBinding
...
class BAPerformStatusActivity : BaseActivity() {
    private lateinit var binding: ActivityBaPerformstatusBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        binding = DataBindingUtil.setContentView(this, R.layout.activity_ba_performstatus)
