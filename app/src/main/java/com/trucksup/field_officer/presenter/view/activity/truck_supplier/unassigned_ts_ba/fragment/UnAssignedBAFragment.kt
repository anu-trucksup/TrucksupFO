...
import com.trucksup.field_officer.databinding.FragmentUnassignedBaBinding
import com.trucksup.field_officer.presenter.view.activity.truck_supplier.unassigned_ts_ba.adapter.UnAssignedBAdapter
...
class UnAssignedBAFragment : Fragment() {
    ...
    private fun setRvList() {
        ...
        binding.rvActiveBA.apply {
            ...
            adapter = UnAssignedBAdapter(aContext, list).apply {
                setOnControllerListener(object : UnAssignedBAdapter.ControllerListener {
