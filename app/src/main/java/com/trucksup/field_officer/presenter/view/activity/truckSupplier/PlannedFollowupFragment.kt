...
import com.trucksup.field_officer.databinding.FragmentPlannedFollowupBinding
import com.trucksup.field_officer.presenter.view.activity.financeInsurance.vml.FinanceHistoryViewModel
import dagger.hilt.android.AndroidEntryPoint


@AndroidEntryPoint
class PlannedFollowupFragment(val status: String, private val historyList: ArrayList<InquiryHistoryResponse.InquiryHistory>) : Fragment() {
    private var aContext: Context? = null
    private lateinit var binding: FragmentPlannedFollowupBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentPlannedFollowupBinding.inflate(inflater, container, false)
        return binding.root
    }
