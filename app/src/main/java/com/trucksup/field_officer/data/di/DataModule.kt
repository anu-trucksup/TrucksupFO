...
import com.trucksup.field_officer.data.database.SaloonDB
...
object DataModule {
    ...
    @Provides
    @Singleton
    fun provideTranslationDAO(saloonDB: SaloonDB): SaloonDAO {
        return saloonDB.getSaloonDao()
    }

    @Singleton
    @Provides
    fun provideSaloonDB(@ApplicationContext app: Context): SaloonDB {
